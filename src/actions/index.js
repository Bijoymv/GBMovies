...
export const getMovies = () => async (dispatch) => {
    await axios.get('https://api.themoviedb.org/3/search/movie?api_key=7ceef1611488e1af83939c3725ad00d7&language=en-US&page=1&include_adult=false&query=gandhi')
    .then(result => {
        dispatch({
