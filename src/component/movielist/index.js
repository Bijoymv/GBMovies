...
const MovieList = (props) => {
    const {popularity,poster_path,title,overview,id,clickButton,favMenu,watchMenu,favList,watchList } = props;
    ...
    return(
        <ul 
            ...
            data-test="component-movielist-ul"
        >
            <Media 
                as="li" 
                    ...
                    <ButtonToolbar>
                        {(!(checkIfExist(watchList,id)) && !(favMenu) && !(watchMenu)) &&
                            <Button 
                                ...
                                onClick={() => {submitButton('watch_add',movieItems)}}
                        ...
                        <Button 
                            ...
                            onClick={() => {if(window.confirm('Remove From Watch later ?')){submitButton('watch_del',id)};}}
                        ...
                        <Button 
                            ...
                            onClick={() => {submitButton('fav_add',movieItems)}}
                        ...
                        <Button 
                            variant="outline-light" 
                            onClick={() => {if(window.confirm('Remove From Favourites?')){submitButton('fav_del',id)};}}
