    ...
    <header className="comp-header-container" data-test="comp-header-container">
      <Container className="pl-0 pr-0 mr-0 ml-0" data-test="comp-nav-container">
        <Navbar
          ...
          bg="dark"
          variant="dark"
          data-test="comp-header-nav"
        >
          <Navbar.Brand
            href="#home"
            onClick={() => clickMenuLink("home")}
            data-test="comp-header-brandname"
          >
            G&B Movies
          </Navbar.Brand>
          <Navbar.Brand
            href="#home"
            onClick={() => clickMenuLink("home")}
            data-test="comp-header-logo-container"
          >
            <img
              src={Logo}
              width="100"
          ...
          <Navbar.Toggle
            ...
            data-test="comp-header-nav-toggle"
          />
          <Navbar.Collapse
            id="responsive-navbar-nav"
            data-test="comp-header-nav-collapse"
          >
